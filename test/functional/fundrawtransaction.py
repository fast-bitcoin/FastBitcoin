...
from test_framework.test_framework import BitcoinTestFramework, FASTBITCOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid fastbitcoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.fastbitcoind_processes[1].wait(timeout=FASTBITCOIND_PROC_WAIT_TIMEOUT)
