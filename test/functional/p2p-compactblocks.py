...
# TestNode: A peer we use to send messages to fastbitcoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes fastbitcoind to (reasonably!) disconnect us, so do this last.
    ...
    # fastbitcoind's choice of nonce.
    ...
    # Test that fastbitcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for fastbitcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # fastbitcoind will not send blocktxn responses for blocks whose height is
