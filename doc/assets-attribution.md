The following is a list of assets used in the fastbitcoin source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original fastbitcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/fastbitcoin.icns, src/qt/res/src/fastbitcoin.svg,
	src/qt/res/src/fastbitcoin.ico, src/qt/res/src/fastbitcoin.png,
	src/qt/res/src/fastbitcoin_testnet.png, docs/fastbitcoin_logo_doxygen.png,
