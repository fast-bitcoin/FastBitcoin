Fastbitcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/fastbitcoin/files/Fastbitcoin/fastbitcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Fastbitcoin
...
New/changed settings (command-line or fastbitcoin.conf file)
--------------------------------------------------------
