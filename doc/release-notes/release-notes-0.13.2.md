Fastbitcoin Core version 0.13.2 is now available from:
  ...
  <https://fastbitcoin.org/bin/fastbitcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update fastbitcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow fastbitcoin-tx to create v2 transactions (btcdrak)
