Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/fastbitcoin/files/Bitcoin/fastbitcoin-0.7.0/

We recommend that everybody running prior versions of fastbitcoind/Bitcoin-Qt
