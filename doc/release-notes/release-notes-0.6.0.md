...
http://sourceforge.net/projects/fastbitcoin/files/Bitcoin/fastbitcoin-0.6.0/test/
...
versions of Bitcoin-Qt/fastbitcoind.
...
fastbitcoin: URIs onto the Bitcoin-Qt window to start
payment.
