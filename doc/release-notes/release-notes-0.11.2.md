Bitcoin Core version 0.11.2 is now available from:
  ...
  <https://fastbitcoin.cc/bin/fastbitcoin-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include fastbitcoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split fastbitcoin-tx into its own package
