...
Fastbitcoin Core 0.11.0 is forked off the Fastbitcoin Core 0.9.3. The old fastbitcoin
...
notes of Fastbitcoin Core  0.9.0, 0.9.1, 0.9.2, 0.9.2.1, 0.9.3 and was completed
with the  introduced changes to the Fastbitcoin Core 0.11.0.
