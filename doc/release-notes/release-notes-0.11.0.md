Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://fastbitcoin.cc/bin/fastbitcoin-core-0.11.0/>
...
For example, add the following to `fastbitcoin.conf`:
...
related to the blockchain in the fastbitcoin system: the raw blocks as received over 
...
For an example script see [fastbitcoin-submittx](https://github.com/laanwj/fastbitcoin-submittx).
...
- #5334 `cf87536` libfastbitcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new fastbitcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add fastbitcoin logo to about screen
...
- #5809 `46bfbe7` Add fastbitcoin-cli man page
...
- #5849 `41259ca` contrib/init/fastbitcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for fastbitcoin-tx)
