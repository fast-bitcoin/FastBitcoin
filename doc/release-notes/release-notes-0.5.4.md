Fastbitcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/fastbitcoin/files/Fastbitcoin/fastbitcoin-0.5.4/
...
http://gitorious.org/fastbitcoin/fastbitcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Fastbitcoin-Qt notifications under Growl 1.3.
Increase required age of Fastbitcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFastbitcoin properly when installing Fastbitcoin-Qt over it. (Windows)
