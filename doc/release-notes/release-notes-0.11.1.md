Bitcoin Core version 0.11.1 is now available from:
  ...
  <https://fastbitcoin.cc/bin/fastbitcoin-core-0.11.1/>
...
(see https://github.com/fastbitcoin/fastbitcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libfastbitcoinconsensus: avoid a crash in multi-threaded environments
