...
*Setup instructions for a gitian build of Fastbitcoin using a Debian VM or physical system.*
...
- [Building Fastbitcoin](#building-fastbitcoin)
...
git clone https://github.com/fastbitcoin/fastbitcoin
```
...
In [doc/release-process.md](release-process.md) in the fastbitcoin repository under 'Fetch and build inputs'.
...
Building Fastbitcoin
----------------

To build Fastbitcoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the fastbitcoin repository.
...
Output from `gbuild` will look something like
    ...
    From https://github.com/fastbitcoin/fastbitcoin
...
For example:
```bash
URL=https://github.com/laanwj/fastbitcoin.git
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/fastbitcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/fastbitcoin-build.assert
```
...
[fastbitcoin/gitian.sigs](https://github.com/fastbitcoin/gitian.sigs/) repository, or
