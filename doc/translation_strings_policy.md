...
This document provides guidelines for internationalization of the Fastbitcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fastbitcoin_en.ts` remains unchanged.
