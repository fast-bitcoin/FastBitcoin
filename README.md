...
FastBitcoin 0.14.0.6 Release notes
==========================
...
----------------------------
Moving forward, we've dropped support for both InstantTX and DarkSend. With the SegWit upgrade these features are going to be superseeded by far superior technology. SegWit will enable the FastBitcoin to adopt the Lightning Network (https://lightning.network/lightning-network-paper.pdf), cross-chain atomic swaps, advanced versions of TumbleBit (https://eprint.iacr.org/2016/575.pdf) and more.
...
[v0.11.2 Release Notes](https://github.com/LIMXTEC/FastBitcoin/blob/Fastbitcoin-0.14/doc/release-notes/release-notes-0.11.2.md)

[v0.12.0 Release Notes](https://github.com/LIMXTEC/FastBitcoin/blob/Fastbitcoin-0.14/doc/release-notes/release-notes-0.12.0.md)

[v0.12.1 Release Notes](https://github.com/LIMXTEC/FastBitcoin/blob/Fastbitcoin-0.14/doc/release-notes/release-notes-0.12.1.md)

[v0.13.0 Release Notes](https://github.com/LIMXTEC/FastBitcoin/blob/Fastbitcoin-0.14/doc/release-notes/release-notes-0.13.0.md)

[v0.13.1 Release Notes](https://github.com/LIMXTEC/FastBitcoin/blob/Fastbitcoin-0.14/doc/release-notes/release-notes-0.13.1.md)

[v0.13.2 Release Notes](https://github.com/LIMXTEC/FastBitcoin/blob/Fastbitcoin-0.14/doc/release-notes/release-notes-0.13.2.md)

[v0.14.0 Release Notes](https://github.com/bitcoin/bitcoin/blob/master/doc/release-notes/release-notes-0.14.0.md)

Release 21.03.2017
----------------
Update FastBitcoin 1.2.7.1
...
Fastbitcoin is an experimental and new digital currency that enables anonymous, instant
payments to anyone, anywhere in the world. Fastbitcoin uses peer-to-peer technology
to operate without a central authority: transaction management and money subsidy
are carried out collectively by the network. Fastbitcoin Core is the name of open
source software which enables the use of this currency.

For more information, as well as an immediately useable, binary version of
the Fastbitcoin Core software, see http://www.fastbitcoin.info
...
[Tags](https://github.com/LIMXTEC/FastBitcoin/tags) are created to indicate new official,
stable release versions of FastBitcoin Core.
...
**compiling Fastbitcoin from git**
...
https://github.com/LIMXTEC/FastBitcoin/releases
...
Run with the -testnet option to run with "play fastbitcoins" on the test network, if you
...
Fastbitcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
