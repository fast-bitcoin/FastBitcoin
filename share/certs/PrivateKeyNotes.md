...
unlocked to sign the Fastbitcoin-Qt.app bundle.
...
allowing somebody to distribute a Fastbitcoin-Qt.app or fastbitcoin-qt-setup.exe with a valid
...
that the fastbitcoin-qt.exe file inside the installer had not been tampered with.
