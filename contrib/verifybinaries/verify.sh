...
###   This script attempts to download the signature file SHA256SUMS.asc from fastbitcoin.org
...
RCSUBDIR="test"
BASEDIR="https://fastbitcoin.org/bin/"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Fastbitcoin Core binary release signing key installed?"
   fi
