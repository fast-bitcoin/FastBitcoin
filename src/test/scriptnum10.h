...
#ifndef FASTBITCOIN_TEST_SCRIPTNUM10_H
#define FASTBITCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Fastbitcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // FASTBITCOIN_TEST_BIGNUM_H
