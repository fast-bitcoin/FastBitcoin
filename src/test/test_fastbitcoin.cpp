...
#define BOOST_TEST_MODULE Fastbitcoin Test Suite

#include "test_fastbitcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_fastbitcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
