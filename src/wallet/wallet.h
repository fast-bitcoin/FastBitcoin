...
#ifndef FASTBITCOIN_WALLET_WALLET_H
#define FASTBITCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this fastbitcoin node, and set to 0 for transactions that were created
...
#endif // FASTBITCOIN_WALLET_WALLET_H
