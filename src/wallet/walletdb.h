...
// Copyright (c) 2009-2019 The Bitcoin Core developers// Copyright (c) 2009-2019 The Litecoin Core developers// Copyright (c) 2009-2016 The Fastbitcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FASTBITCOIN_WALLET_WALLETDB_H
#define FASTBITCOIN_WALLET_WALLETDB_H
...
#endif // FASTBITCOIN_WALLET_WALLETDB_H
