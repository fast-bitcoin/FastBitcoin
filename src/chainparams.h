...
#ifndef FASTBITCOIN_CHAINPARAMS_H
#define FASTBITCOIN_CHAINPARAMS_H
 ...
 * Fastbitcoin system. There are three: the main network on which people trade goods
...
#endif // FASTBITCOIN_CHAINPARAMS_H
