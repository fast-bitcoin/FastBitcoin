 ...
 */
#ifndef FASTBITCOIN_UTIL_H
#define FASTBITCOIN_UTIL_H
...
extern const char * const FASTBITCOIN_CONF_FILENAME;
extern const char * const FASTBITCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("fastbitcoin-%s", name);
